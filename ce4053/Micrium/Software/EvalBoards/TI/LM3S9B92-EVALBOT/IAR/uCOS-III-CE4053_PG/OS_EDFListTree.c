...
*/
Tree * SchedulerTree;
CPU_INT32U *MemoryPartition2 [10][10];
OS_MEM MemoryCB2;
/*
*********************************************************************************************************
*                                          SCHEDULER LIST INITILIZATION
*
...
void EDFTreeInit(void)
{
  ...
  OSMemCreate((OS_MEM*)&MemoryCB2, (CPU_CHAR*)"Splay_tree_node", &MemoryPartition2[0][0], (OS_MEM_QTY)(10), (OS_MEM_SIZE)(10*node_size), &err);
  SchedulerTree = NULL;
}
/*
*********************************************************************************************************
...
*********************************************************************************************************
*/
Tree * edf_splay (OS_TASK_DEADLINE i, Tree * t) {
...
*********************************************************************************************************
*/
Tree * InsertEDFTree(OS_TASK_DEADLINE i, Tree * t, OS_TCB* block) {
/* Insert i into the tree t, unless it's already there.    */
/* Return a pointer to the resulting tree.                 */
    Tree * new1;
    OS_ERR  err;
    new1 = (Tree *) OSMemGet((OS_MEM*)&MemoryCB2, (OS_ERR*)&err);
    if (new1 == NULL) {
      err = OS_ERR_Z;
    }
    ...
    if (i < t->release_time) {
      ...
      /* Don't add it again                      */
      OSMemPut((OS_MEM*)&MemoryCB2, (void*)new1,(OS_ERR*)&err);
      //free(new1);
      return t;
    }
}
...
*********************************************************************************************************
*/
Tree * DelEDFTree(OS_TASK_DEADLINE i, Tree * t) {
...
/* Return a pointer to the resulting tree.              */
  ...
  if (i == t->release_time) {               /* found it */
    if (t->left == NULL) {
        ...
        x = edf_splay(i, t->left);
        x->right = t->right;
    }
    OSMemPut((OS_MEM*)&MemoryCB2, (void*)t,(OS_ERR*)&err);
    //free(t);
    return x;
    }
  else{
