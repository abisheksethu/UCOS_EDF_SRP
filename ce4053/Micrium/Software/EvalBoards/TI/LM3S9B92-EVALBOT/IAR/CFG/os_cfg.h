...
#define OS_CFG_OBJ_TYPE_CHK_EN          0u   /* Enable (1) or Disable (0) object type checking                        */ //Disabled-1
...
#define OS_CFG_MUTEX_EN                 1u   /* Enable (1) or Disable (0) code generation for MUTEX                   */ //IMPORTANT
...
#define OS_CFG_MUTEX_PEND_ABORT_EN      0u   /*     Include code for OSMutexPendAbort()                               */
                                             ...
                                             /* --------------------------- MESSAGE QUEUES -------------------------- */
#define OS_CFG_Q_EN                     1u   /* Enable (1) or Disable (0) code generation for QUEUES                  */ //IMPORTANT
...
#define OS_CFG_Q_PEND_ABORT_EN          0u   /*     Include code for OSQPendAbort()                                   */
                                             ...
                                             /* ----------------------------- SEMAPHORES ---------------------------- */
#define OS_CFG_SEM_EN                   0u   /* Enable (1) or Disable (0) code generation for SEMAPHORES              */ //Disabled-8
#define OS_CFG_SEM_DEL_EN               0u   /*    Include code for OSSemDel()                                        */
#define OS_CFG_SEM_PEND_ABORT_EN        0u   /*    Include code for OSSemPendAbort()                                  */
#define OS_CFG_SEM_SET_EN               0u   /*    Include code for OSSemSet()                                        */ //Disabled-5
...
#define OS_CFG_TASK_PROFILE_EN          0u   /* Include variables in OS_TCB for profiling                             */ //Disabled-9
#define OS_CFG_TASK_REG_TBL_SIZE        0u   /* Number of task specific registers                                     */ //Disabled-10
...
#define OS_CFG_TASK_SUSPEND_EN          1u   /* Include code for OSTaskSuspend() and OSTaskResume()                   */
                                             ...
                                             /* -------------------------- TIME MANAGEMENT -------------------------- */
#define OS_CFG_TIME_DLY_HMSM_EN         0u   /*     Include code for OSTimeDlyHMSM()                                  */ //Disabled-7
